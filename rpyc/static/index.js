...
var updateAll = function () {
    ...
    $.ajax({
        ...
        success: function(data){
            console.log(data)
            liveUpdate(100,data.speed)
            $("#ping").text("PING: "+data.ping+" ms")
            $("#download").text("DOWNLOAD: "+data.download+" Mbps")
            $("#upload").text("UPLOAD: "+data.upload+" Mbps")
...
$("#setDNS").on("click",SetDNS)
$("#getDNS").on("click",GetDNS)
